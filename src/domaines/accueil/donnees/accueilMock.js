export const heroSlides = [
  { id: "audiva-pour-vous", trackId: "afterglow", image: "/hero-recommandation.jpg", position: "object-[58%_40%]", badge: "Pour vous", overline: "Bienvenue dans Audiva", title: "Ta musique. Ton univers.", artist: "Des sons qui suivent ton rythme.", description: "Retrouve tes coups de cœur, tes découvertes et les ambiances qui te ressemblent, réunis au même endroit.", actionLabel: "Lancer l’écoute", action: "play", gradient: "from-[#06122e] via-[#07183a]/80 to-[#021427]/30" },
  { id: "audiva-playlist", trackId: "nuit-electrique", image: "/hero-playlist.jpg", position: "object-[52%_50%]", badge: "Playlists intelligentes", overline: "Une ambiance pour chaque instant", title: "Laisse Audiva trouver le bon son.", artist: "Des sélections pensées pour maintenant.", description: "Concentre-toi, danse, voyage ou ralentis : compose et retrouve des playlists adaptées à chaque envie.", actionLabel: "Explorer les playlists", action: "playlist", gradient: "from-[#100c2e] via-[#102052]/80 to-[#06152a]/30" },
  { id: "audiva-decouverte", trackId: "lila-sun", image: "/hero-decouverte.jpg", position: "object-[68%_45%]", badge: "Nouvelles découvertes", overline: "L’inspiration commence ici", title: "Découvre ce qui pourrait devenir ton prochain favori.", artist: "Une nouvelle écoute n’est jamais loin.", description: "Explore les univers, les genres et les recommandations qui font vivre ta bibliothèque musicale.", actionLabel: "Partir à la découverte", action: "discover", gradient: "from-[#071d28] via-[#09253f]/80 to-[#02101f]/30" },
  { id: "audiva-communaute", trackId: "afro-future", image: "/hero-tendances.jpg", position: "object-[48%_30%]", badge: "La communauté Audiva", overline: "La musique se partage", title: "Ce que tu aimes mérite d’être partagé.", artist: "Crée des liens autour de tes sons.", description: "Envoie une playlist, partage un morceau et fais de chaque écoute une conversation avec ton cercle.", actionLabel: "Voir les tendances", action: "trending", gradient: "from-[#1a102a] via-[#11264c]/80 to-[#050b18]/30" },
